...
let lat = "40.25631";
let lon = "40.22289";
const CURRENTWEATHERAPI = `https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?lat={0}&lon={1}&appid=${process.env.VUE_APP_API_OMAP_KEY}`;
